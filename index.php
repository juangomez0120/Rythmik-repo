            ...
            <div class="container-fluid mx-md-5 mx-sm-2">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item m-3">
                        <a style="color: #EA0D43;" class="nav-link" aria-current="page" href="#">METODOLOGÍA R</a>
                    </li>
                    <li class="nav-item m-3">
        ...
        <div class="container-fluid texto-pagina-1">
            <div class="row mt-5 mx-md-5 mx-sm-2">
                <div class="col-lg-8 col-12">
                    ...
                    <p class="light mb-4">Hay una enorme diferencia entre construir un negocio y una marca. Descuidar la construcción de tu marca frena el alcance de tu negocio. <span class="bold">El primer paso es conocer el estatus de tu marca, el segundo, desatar su potencial.</span></p>        
                    <button onclick="window.open('https://linktr.ee/rythmik.mx','_blank')" class="boton-rojo-1 texto-boton">Realiza aquí el diagnostico de tu marca</button>
                </div>
            </div>
            <div class="row mx-md-5 mx-sm-2 segundo-texto-index justify-content-center">
                ...
                <class class="col-lg-8 col-12 poder-impactar">
                    ...
                    <p class="mb-4">Eso es lo que diferencia a tu negocio de la competencia y mantiene su vigencia en tiempos inciertos. <span>Te ayudamos con la construcción de una marca sólida que te lleve a nuevos hotizontes y te ayude a conectar con tu audiencia.</span> Libera todo ese potencial creando experiencias que conecten, den voz y ritmo a tu negocio.</p>
    ...
    <div id="metodologia">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-8">
                    <h1 class="font-metodologia titulo-metodologia">UNA MARCA QUE SOBRESALE EMPIEZA CON FUNDAMENTOS SÓLIDOS</h1>
                    <p class="texto-metodologia-1">Hacer de la construcción de tu marca un proceso claro y estructurado con el desarrollo total de la metodología R, una metodología diseñada para el desarrollo de marcas que buscan aprovechar todo su potencial.</p>
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        ...
                        <div class="col-8 contenedor-lista">
                            <h3 class="font-metodologia">DIAGNÓSTICO</h3>
                            <p class="sub-lista">CONÓCE EL ESTATUS DE TU MARCA</p>
                            <p>El primer paso es diagnosticar el estado actual de tu marca, <span>así sabremos en dónde hay que trabajar y en dónde tendrá mayor efecto tu inversión.</span></p>
                            <button onclick="window.open('https://linktr.ee/rythmik.mx','_blank')" class="boton-metodologia-1 texto-boton">Realiza tu diagnóstico</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
                    <div class="row">
                        ...
                        <div class="col-8 contenedor-lista">
                            ...
                            <p><span>El siguiente es establecer un plan de acción para desarrollar cada elemento de la marca</span> de forma que haya ritmo, armonía y coherencia en cada uno.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
                    <div class="row">
                        ...
                        <div class="col-8 contenedor-lista">
                            ...
                            <p class="sub-lista">EJECUCIÓN DE EXPERIENCIAS CREATIVAS</p>
                            <p>Una vez desarrollada la estrategia, es momento de ponerla en acción en diferentes medios para <span>atraer a tu audiencia e impulsar tu negocio.</span></p>
                            <button onclick="window.open('http://rythmik.mx/servicios.html','_blank')" class="boton-metodologia texto-boton">Conóce nuestros servicios</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="info-metodologia row justify-content-between" id="parent-metodologia">
                <div class="row justify-content-lg-between justify-content-md-center mb-5 opciones-metodologia" id="opciones-met">
                    ...
                    <button id="boton-expresion" class="col-md-4 col-lg-2">EXPRESIÓN</button>
                </div>
                <div class="texto-metodologia col-lg-3 col-12 align-self-center" id="texto-metodologia-r">
                    <h3 class="font-metodologia" id="titulo-metodologia">METODOLOGÍA R</h3>
                    <p class="sub-lista" id="subtitulo-metodologia">TRABAJAMOS CON LAS MARCAS DE MANERA 360&#186;</p>
                    <p id="p-metodologia-1">Estar al frente de un proyecto es bastante demandante. Conforme crece, se vuelve difícil ver el mapa completo de lo que necesitamos trabajar y en ocasiones hace falta una guía que nos lleve al siguiente paso y ponga órden en los temas en los que necesitamos trabajar.</p>
                    <p id="p-metodologia-2">De ahí nace la <span>metodología R, diseñada para que cada elemento de la marca tenga ritmo, coherencia y que la marca en su conjunto se transforme en una experiencia memorable.</span></p>
                </div>
        ...
        <div class="row justify-content-between mx-md-5 mx-sm-2">
            ...
            <div class="col-lg-6 col-12 contactanos-box">
                <form action="" method="POST">
                    <h1 class="font-metodologia">CONTÁCTANOS</h1>
